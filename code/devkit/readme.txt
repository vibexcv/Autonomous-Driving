...
objects larger than 30 pixel (height) in the image and do not count Vans as
false positives for cars or Cyclists as wrong positives for pedestrians due
to their similarity in appearance. As evaluation criterion we follow
